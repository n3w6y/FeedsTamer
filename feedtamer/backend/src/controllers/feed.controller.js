...
exports.getFeed = catchAsync(async (req, res, next) => {
  ...
  // Build feed options from query parameters
  const options = {
  ...
  const content = await Content.getFeedForUser(userId, accountIds, options);
...
// Get feed grouped by platform
exports.getFeedByPlatform = catchAsync(async (req, res, next) => {
  const userId = req.user._id;
  ...
  for (const platform of platforms) {
    ...
    const platformContent = await Content.getFeedForUser(userId, accountIds, options);
