...
// Index for efficient Feeds generation queries
...
// Static method to get content for a user's Feeds
contentSchema.statics.getFeedsForUser = async function(userId, accounts, options = {}) {
  const {
    limit = 20,
    skip = 0,
    platform = null,
